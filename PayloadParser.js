function parseUplink(device, payload)
{
	...
	{
		temperatureSensor.updateTemperatureSensorStatus(payload.temperature);
	}
	...
	{
		humiditySensor.updateHumiditySensorStatus(payload.humidity);
	}	  
	
	// Parse and store battery percentage
	device.updateDeviceBattery({ percentage: payload.battery });
